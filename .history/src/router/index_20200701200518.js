...
Vue.use(VueRouter)
  ...
  },
  {
    path: '/myinformation',
    name: 'myinformation',
    component: () => import(/* webpackChunkName: "about" */ '../views/myinformation/myinformation.vue'),
    meta:{
      title:'个人信息',
    },
  },
  ...
  },
  {
    ...
    component: () => import(/* webpackChunkName: "about" */ '../views/evaluationDetails/evaluationDetails'),
    meta:{
      title:'已完成评价详情',
    },
  },
