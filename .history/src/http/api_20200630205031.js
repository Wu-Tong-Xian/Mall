  ...
  // 5. 购物车加减商品(post)  /editCart  参数: count: 购物车数量  id: 商品id
  // mallPrice: 价格
  ...
  // 17. 商品评论(post) /goodsOne/comment 参数: id: 商品cid rate: 分数 content: 内容 
  ...
  // 26. 登录(post) /login 参数: nickname: 用户名 password:密码 verify:验证码
  ...
  // 30. 查询单条评论(post) //evaluateOne 参数:  id:商品id _id:数据库的那条id
  get(id,_id) {
