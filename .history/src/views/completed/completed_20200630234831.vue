<template>
  <div>
    ...
    <van-divider />
    <div v-for="(item) in list" :key="item.id" class="bg" v-if="item.order_list.length ===1">
      <div class="box-bx">
    ...
    <div v-for="(item) in list" :key="item.id" class="bg2" v-if="item.order_list.length ===2">
      <div class="box-bx2">
        <div class="mg-l10 pd-t10">订单编号:{{item.order_id}}</div>
        <van-divider />
        <div v-for="(item1) in item.order_list" :key="item1.id">
          <div class="fl">
            <div class="box-border fl">
              <img :src="item1.image_path" alt />
            </div>
            <div class="p-r">
              <div class="fl">
