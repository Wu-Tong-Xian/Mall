<template>
  <div class="img">
    ...
    <div class="contente">
      ...
      <!-- 输入任意文本 -->
      <van-field v-model="nickname" error required placeholder="username" />
      <!-- 输入密码 -->
      <van-field v-model="password" error required type="password" placeholder="password" />
      <!-- 输入手机号，调起手机号键盘 -->
...
export default {
  ...
  methods: {
    ...
    register(){
      if(this.nickname == /^[a-zA-Z]\w{4,15}$/){
        this.$api
        ...
        this.$toast('帐号不合法(允许字母开头,5-16字节,允许字母数字下划线组合')
      }
      
    },
    // 26. 登录(post)
// /login   参数:   nickname: 用户名     password:密码    verify:验证码
