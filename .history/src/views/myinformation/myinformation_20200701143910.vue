<template>
  <div>
    ...
    <div class="mobile">
      <div><van-button square type="primary"  @click="keep" block>保存</van-button></div>
    <div><van-button plain type="primary" lass="cancel" @click="cancel" block>取消</van-button></div>
    </div>
  </div>
</template>
