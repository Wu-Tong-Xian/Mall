      ...
      <div class="cate-body">
        ...
        <div class="cate-main">
          ...
          <van-tabs v-model="active" @click="getClassification">
            ...
            <van-cell v-else v-for="item in catelist" :key="item.id" @click="godetails(item.id,item)">
...
export default {
  ...
  methods: {                           //mallSubId 
    ...
    getClassification() {
      ...
      let ids = this.bxMallSubDtos[this.active].mallSubId;   //active 侧边导航自带的监听
    ...
    godetails(id,item) {
      ...
      // 如果登录了 就把点击的这一项通过模块话的方式存在localStorage里面
