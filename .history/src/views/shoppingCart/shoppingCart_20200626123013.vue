  ...
  <div>
    ...
    <div v-else>
      ...
      <div v-else>
        ...
        <!--全选按钮-->
           <div class="fl"><van-switch v-model="checked" size="24px" active-color="#07c160" inactive-color="#ee0a24" />
            <div>全选</div></div>
            
            <div class="col5">合计：￥0.00</div>
          </div>
        </div>
        ...
        <div v-for="(item,index) in shopList" :key="item.id" class="fl j-center">
        <!-- vant 组件库单选框-->
         <div class="fl mg-r10 j-between"> <!--复选框-->
           <van-checkbox :name="index" v-model="item.check" ></van-checkbox>
         <!--商品图片-->
