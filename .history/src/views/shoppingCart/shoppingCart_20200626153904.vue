    ...
    <div v-else>
      ...
      <div v-else>
        ...
        <div class="fl j-between mg-lr10">
          <!--全选按钮-->
          <van-checkbox v-model="checked" @click="checkAll" checked-color="#E81123">全选</van-checkbox>{{checked}}
          <div class="fl">
            <div>合计：</div>
      ...
      <div v-for="(item,index) in shopList" :key="index" class="fl j-center">
        ...
        <div class="fl mg-r10 j-between">
          <!--多选框-->
          <van-checkbox v-model="item.check" @click="" checked-color="#E81123"></van-checkbox>{{item.check}}
          <!--商品图片-->
          <div class="border1">
