      ...
      <div class="mg-l20">
        <div class="mg-l20" @click="clickImg">
          <van-swipe  :autoplay="3000" indicator-color="white">
            <van-swipe-item><img :src="goodsDetail.image_path" alt  /></van-swipe-item>
            <van-swipe-item><img :src="goodsDetail.image_path" alt  /></van-swipe-item>
            <van-swipe-item><img :src="goodsDetail.image_path" alt  /></van-swipe-item>
          </van-swipe>
        </div>
    ...
    <div v-else class="bg">
      <div class="mg-l20" @click="clickImg">
          <van-swipe class="my-swipe" :autoplay="3000" indicator-color="white">
            <van-swipe-item><img :src="goodsDetail.image" alt  /></van-swipe-item>
            <van-swipe-item><img :src="goodsDetail.image" alt  /></van-swipe-item>
            <van-swipe-item><img :src="goodsDetail.imageh" alt  /></van-swipe-item>
          </van-swipe>
        </div>
    </div>
    <div>
