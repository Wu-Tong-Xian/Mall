  ...
  <div>
    ...
    <div v-else>
      ...
      <van-goods-action>
        ...
        <van-goods-action-icon v-if="count === 0" icon="cart-o" @click="shoppingCart" text="购物车"  />
        <van-goods-action-icon v-else-if="count > 99" icon="cart-o" @click="shoppingCart" text="购物车" badge="99+" />
        <van-goods-action-icon v-else icon="cart-o" @click="shoppingCart" text="购物车" :badge="count" />
