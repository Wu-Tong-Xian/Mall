  ...
  <div>
    ...
    <div v-else>
      ...
      <van-goods-action>
        ...
        <van-goods-action-icon v-if="shopingCount === 0" icon="cart-o" @click="shoppingCart" text="购物车"  />
        <van-goods-action-icon v-else-if="shopingCount > 99" icon="cart-o" @click="shoppingCart" text="购物车" badge="99+" />
        <van-goods-action-icon v-else icon="cart-o" @click="shoppingCart" text="购物车" :badge="shopingCount" />
            ...
            this.$api
              ...
              .then(res => {
                ...
                if(res.shopList.length !==0){ //如果购物车有东西
                  ...
                  this.$store.state.shopingCount.length
                }
                console.log(res);
              })
              .catch(err => {
