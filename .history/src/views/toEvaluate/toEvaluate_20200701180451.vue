<template>
  <div>
    ...
    <div>
    <!--文本域输入框-->
      <textarea name="DIVCSS5" cols="45" v-model="anonymous" placeholder="分享您的购买体验吧~~" rows="10"> </textarea>
    </div>
    <van-checkbox v-model="checked" class="mg-l10 mg-tb20" checked-color="#07c160">匿名评价</van-checkbox>
    <van-button type="primary" class="mg-r10 mg-l10 mg-tb20" block>发表评论</van-button>
  </div>
</template>

<script>
import { Rate } from "vant"; //引入vant rate评分
