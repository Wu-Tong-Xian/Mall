          ...
          <div class="fl j-between fz14">
            <div class="fl j-between">
              ...
              <div class="mg-l10">
                ...
                <!--用户评分-->
                <div><van-rate v-model="completed.rate" readonly allow-half void-icon="star" void-color="#eee" /></div>
              </div>
            </div>
            <!--评论时间-->
            <div class="time">{{completed.comment_time}}</div>
          </div>
          <!--评价内容-->
          <div class="mg-l20">评价内容:{{completed.content}}</div>
          <van-divider />
          <div>
            <div></div>
            <div></div>
