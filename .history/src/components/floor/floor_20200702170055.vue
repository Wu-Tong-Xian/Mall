...
export default {
  ...
  methods: {
    ...
    godetails(val,index) {
      ...
      this.$utils.recentlyViewed(this.floor1[index])
      this.$utils.recentlyViewed(this.floor2[index])
      this.$utils.recentlyViewed(this.floor3[index])
    }
  },
  mounted() {},
  watch: {},
...
.img2 {
  ...
  border-left: 1px solid rgb(241, 216, 216);
}
