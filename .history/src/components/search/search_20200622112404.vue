...
<template>
  <div class="search-bg">
    ...
    <div v-if="inputs === ''">
      <div>
        <div class="flexbtw search-His fl j-between">
          <div>搜索历史</div>
...
export default {
  ...
  methods: {
    ...
    let findText =item.name.split(this.inputs)
    this.searchlist.name = findText.join('<span style="color:red;">' + this.inputs + '</span> ')
            })
